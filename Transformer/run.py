...
def get_hyper_parameter():
    ...
    parser.add_argument("--model", type=str, default="Transformer")              # Model Name
    ...
    parser.add_argument("--nhead", type=int, default=3)                                    # Number of attention heads
    parser.add_argument("--num_layers", type=int, default=3)                               # Number of layers
    parser.add_argument("--mlp_ratio", type=int, default=16)                               # MLP ratio
