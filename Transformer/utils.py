...
def parameter_printing(args):
    ...
    print("K Fold SEED          = {}".format(args.k_fold_SEED))
    ...
    print("Weather Normalize    = {}".format(args.weather_normalize))
    print("Phenotype            = {}".format(args.phenotype))
    print("Weather Type         = {}".format(args.weather_type))
    print("Num Head             = {}".format(args.nhead))
    print("Num Layers           = {}".format(args.num_layers))
    print("Mlp Ratio            = {}".format(args.mlp_ratio))
...
def results_printing(config, max_cor, max_cor_epoch, last_cor, min_MSE, min_MSE_epoch, last_MSE):
    ...
    file.write('SEED                  = {} \n'.format(config.SEED))
    file.write('Model                 = {} \n'.format(config.model))
    file.write('K Fold SEED           = {} \n'.format(config.k_fold_SEED))
    ...
    file.write('Weather Normalize     = {} \n'.format(config.weather_normalize))
    file.write('Phenotype             = {} \n'.format(config.phenotype))
    file.write('Weather Type          = {} \n'.format(config.weather_type))
    file.write('Num Heads             = {} \n'.format(config.nhead))
    file.write('Num Layers            = {} \n'.format(config.num_layers))
    file.write('Mlp Ratio             = {} \n'.format(config.mlp_ratio))
...
def get_model_checkpoint_path():
    ...
    checkpoint_filename = f"{timestamp}_{unique_id}_TransformerEarlyFusion.pt"
